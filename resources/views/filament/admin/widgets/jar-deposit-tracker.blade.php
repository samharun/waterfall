...
<div class="wf-dashboard-card" wire:poll.120s wire:loading.class="wf-dashboard-card--loading" style="background:#fff;border:1px solid #e5e7eb;border-radius:12px;overflow:hidden;box-shadow:0 1px 3px rgba(0,0,0,.07)">
